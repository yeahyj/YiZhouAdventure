 ...
 * 通用布局,在房间中随机添加箱子
 */
@ecs.register('DungeonLayoutCommon1Comp')
export class DungeonLayoutCommon1Comp extends ecs.Comp {
    reset(): void {}
}

/**通用布局系统 */
export class DungeonLayoutCommon1System extends ecs.ComblockSystem<ecs.Entity> implements ecs.IEntityEnterSystem {
    filter(): ecs.IMatcher {
        return ecs.allOf(DungeonLayoutCommon1Comp, RoomModelComp);
    }

    entityEnter(e: ECSEntity): void {
        this.randomGenerateBox(e);
        e.remove(DungeonLayoutCommon1Comp);
    }
