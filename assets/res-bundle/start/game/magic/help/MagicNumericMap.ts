...
import { MagicNumeric } from './MagicNumeric';

/**
 * 角色数值管理器
 * 用于管理角色特有属性，如攻击力、防御力等
 */
export class MagicNumericMap extends BaseNumericMap<MagicNumeric> {
    /**
     * 创建角色属性实例
     */
    createNumeric(type: AttributeType): MagicNumeric {
        return new MagicNumeric(type);
    }

    /**
     * 获取属性
     */
    override get(type: AttributeType): MagicNumeric {
