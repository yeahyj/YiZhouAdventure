 ...
 */
@ccclass('BombComp')
@ecs.register('BombComp')
export class BombComp extends ProjectileStoneComp {
    reset(): void {}
}

/**炸弹系统 */
export class BombSystem extends ecs.ComblockSystem<ecs.Entity> implements ecs.IEntityEnterSystem {
    filter(): ecs.IMatcher {
