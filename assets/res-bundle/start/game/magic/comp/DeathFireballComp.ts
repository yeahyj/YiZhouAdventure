 ...
 * 死亡触发火球
 */
@ccclass('DeathFireballComp')
@ecs.register('DeathFireballComp')
export class DeathFireballComp extends BaseMagicStoneComp {
    initStone() {
        let stoneId = StoneId.TriggerDeathComp;
...
/**死亡触发火球系统 */
export class DeathFireballSystem extends ecs.ComblockSystem<ecs.Entity> implements ecs.IEntityEnterSystem {
    filter(): ecs.IMatcher {
        return ecs.allOf(DeathFireballComp);
    }
    ...
    entityEnter(e: ecs.Entity): void {
        ...
        let comp = e.get(DeathFireballComp);
