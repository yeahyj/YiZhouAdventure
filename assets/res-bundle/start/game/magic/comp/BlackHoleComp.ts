 ...
 * 黑洞
 */
@ccclass('BlackHoleComp')
@ecs.register('BlackHoleComp')
export class BlackHoleComp extends ProjectileStoneComp {
    reset(): void {}
}

/**黑洞系统 */
export class BlackHoleSystem extends ecs.ComblockSystem<ecs.Entity> implements ecs.IEntityEnterSystem {
    filter(): ecs.IMatcher {
        return ecs.allOf(BlackHoleComp);
    }
    ...
    entityEnter(e: ecs.Entity): void {
        app.manager.loader.load({
            path: 'skill/blackHole/BlackHole',
            bundle: 'battle',
            type: Prefab,
